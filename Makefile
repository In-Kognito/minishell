...
#    Updated: 2021/11/19 21:43:07 by jinigo           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
${NAME}:	${LIBFT_DIR}${LIBFT} ${OBJS}
			${CC} ${CFLAGS} ${OBJS} ${INCLUDES} -L${LIBFT_DIR} -lreadline -L/Users/jinigo/.brew/Cellar/readline/8.1.1/lib -I/Users/jinigo/.brew/Cellar/readline/8.1.1/include -lft -o ${NAME}
